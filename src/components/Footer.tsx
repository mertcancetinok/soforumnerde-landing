...
export function Footer() {
  return (
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 md:grid-cols-2 justify-between gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700">
          <div>
            <div>
              {" "}
              <Link
